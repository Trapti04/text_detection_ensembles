...
checkpoint = 'BEST_checkpoint_ssd300.pth.tar'#'best4.17.tar' #'BEST_checkpoint_ssd300.pth.tar' #    #' #'best.tar' # #
...
def detect(original_image, min_score, max_overlap, top_k, max_OCR_overlap=1.0, max_OCR_ratio=1.0, suppress=None):
    ...
    font = ImageFont.truetype("NotoSansCJK-DemiLight.ttc", 15)
...
if __name__ == '__main__':
    ...
    img_path = 'updated_task1train_626p/X00016469623.jpg'
    original_image = Image.open(img_path, mode='r')
    original_image = original_image.convert('RGB')
    ...
    img_path = 'updated_task1train_626p/X51007339158.jpg'
    original_image = Image.open(img_path, mode='r')
    original_image = original_image.convert('RGB')
    out_image=detect(original_image, min_score=min_score, max_overlap=max_overlap, top_k=top_k,  max_OCR_overlap=max_OCR_overlap, max_OCR_ratio=max_OCR_ratio)#.show()
    ...
    img_path = 'updated_task1train_626p/X51008123446.jpg'
    original_image = Image.open(img_path, mode='r')
    original_image = original_image.convert('RGB')
    out_image=detect(original_image, min_score=min_score, max_overlap=max_overlap, top_k=top_k,  max_OCR_overlap=max_OCR_overlap, max_OCR_ratio=max_OCR_ratio)#.show()
    ...
    img_path = 'updated_task1train_626p/X00016469612.jpg'
    original_image = Image.open(img_path, mode='r')
    original_image = original_image.convert('RGB')
    out_image=detect(original_image, min_score=min_score, max_overlap=max_overlap, top_k=top_k, max_OCR_overlap=max_OCR_overlap, max_OCR_ratio=max_OCR_ratio)#.show()
    ...
    img_path = 'updated_task1train_626p/X51005433538.jpg'
    original_image = Image.open(img_path, mode='r')
    original_image = original_image.convert('RGB')
    out_image=detect(original_image, min_score=min_score, max_overlap=max_overlap, top_k=top_k,  max_OCR_overlap=max_OCR_overlap, max_OCR_ratio=max_OCR_ratio)#.show()
    ...
    img_path = 'updated_task1train_626p/X51005200938.jpg'
