...
# Parameters
data_folder = 'updated_task1train_626p/'
...
checkpoint = 'BEST_checkpoint_ssd300.pth.tar' #'best4.17.tar' #''BEST_checkpoint_ssd300.pth.tar'
test_img_num = 25
            ...
            for max_overlap in [0.8]:
                ...
                for i, (images, boxes, labels) in enumerate(tqdm(test_loader, desc='Evaluating')):
                    ...
                    if i < test_img_num:
                        ...
                        det_boxes_batch, det_labels_batch, det_scores_batch = model.detect_objects(predicted_locs, predicted_scores,
                                                                                                   min_score=min_score, max_overlap=max_overlap,
                                                                                                   top_k=200, original_image = images, max_OCR_overlap=0.2)                                                                           
